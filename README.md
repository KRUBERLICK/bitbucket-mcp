...
2. В руті проекту додати файл `.mcp.json`, якщо його ще не існує, з наступним контентом, замінивши `PATH_TO_MCP_ROOT` на реальне розташування зклонованого репозиторію (приклад `~/Documents/work/bitbucket-mcp/dist/index.js`):
```json
{
  "mcpServers": {
    "bitbucket": {
